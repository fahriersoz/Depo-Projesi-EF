...
public class UrunTanımlama {
    ...
    static Map<Integer, UrunTanımlama> urunler = DepoUrunListesi.depodakiUrunler();
    private String adi;
    ...
    protected UrunTanımlama() {
    }

    public UrunTanımlama(String adi, String uretici, String birim, int miktar, String raf) {
    ...
    public static Object urunBilgileriAl() {
        ...
        UrunTanımlama urun = new UrunTanımlama(urunAdi, uretciFirma, birim, urunMiktarı, rafIsmi);
    ...
    public static Map<Integer, UrunTanımlama> urunListesiOlustur() {
